...
<body>
    ...
    <div class="layui-logo">集美大学图书管理系统</div>
    <!-- 头部区域（可配合layui已有的水平导航） -->
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item">
        <a href="javascript:;">图书管理</a>
        <dl class="layui-nav-child">
          <dd><a href="<%=basePath%>index.do">图书列表</a></dd>
          <dd><a href="<%=basePath%>bookType.do">分类管理</a></dd>
        </dl>
      </li>
        <li class="layui-nav-item"><a href="<%=basePath%>readerIndex.do">读者列表</a></li>
        <li class="layui-nav-item"><a href="<%=basePath%>listDisBackReader.do">借阅管理</a></li>
    </ul>
